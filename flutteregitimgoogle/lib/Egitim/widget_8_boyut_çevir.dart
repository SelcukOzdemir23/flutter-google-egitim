...
import 'package:flutteregitimgoogle/Egitim/input_page.dart';
        ...
        ElevatedButton(
          ...
          child: RichText(
            text: TextSpan(text: "Öğrencileri ", children: const <TextSpan>[
              TextSpan(text: "Yükle", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20))
            ]),
          ),
          onPressed: () async {
            ...
            child: AspectRatio(
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Image(
                    image: AssetImage("images/Memati_Kurtlar_vadisi_pusu.jpg"),
                  ),
                ),
              ),
            ),
